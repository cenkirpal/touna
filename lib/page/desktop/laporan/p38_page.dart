...
class P38PageState extends State<P38Page> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    if (dataSurat == null) return Container();
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text('Ampana, ${DateTime.parse(dataSurat!.tanggal).fullday}'),
                ],
              ),
              const Row(
                children: [
